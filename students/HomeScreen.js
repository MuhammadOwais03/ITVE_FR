...
const HomeScreen = ({ navigation }) => {
  ...
  // Current user data (you can get this from your auth system)
  const currentUser = {
    id: 'current_user_1',
    name: 'Your Name',
    avatar: null
      ...
      <View style={styles.postHeader}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={styles.username}>
            {post.username} {post.verified && <Ionicons name="checkmark-circle" size={14} color="#00FF87" />}
          </Text>
  ...
  return (
    <LinearGradient colors={["#001F3F", "#003366", "#001A33"]} style={styles.container}>
      ...
      <View style={styles.topBar}>
        ...
        <View style={styles.iconRow}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("MessagesScreen")} activeOpacity={0.7}>
            <Ionicons name="chatbubble-ellipses-outline" size={22} color="white" style={styles.icon} />
          </TouchableOpacity>

          <TouchableOpacity onPress={() => navigation.navigate("NotificationsScreen")} style={{ position: "relative" }} activeOpacity={0.7}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {stories.map((story) => (
              <View key={story.id} style={styles.storyWrapper}>
                <LinearGradient colors={["#ff4b2b", "#ff416c", "#ff7b00"]} style={styles.storyRing}>
      ...
      <Comments
        ...
        // -------------------------
        postImage={getCurrentPost()?.image} 
        postCaption={getCurrentPost()?.caption}
        // -------------------------
...
const styles = StyleSheet.create({
  ...
  storyImage: { width: 60, height: 60, borderRadius: 30, borderWidth: 2, borderColor: "#001F3F" },
  ...
  postTime: { color: "#aaa", fontSize: 11 },
  ...
  caption: { color: "#eee", paddingHorizontal: 12, paddingTop: 5, lineHeight: 18 },
  comments: { color: "#aaa", fontSize: 13, paddingHorizontal: 12, paddingVertical: 10 },
  notificationDot: {
    position: "absolute",
    top: 0,
    right: 0,
